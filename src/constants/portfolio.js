...
export const CATEGORIES = ['All', 'Logos', 'Flyers', 'Social Media'];
...
export const GRAPHIC_DESIGNS = [
  { 
    ...
    description: 'Modern restaurant menu layout'
  },
  { 
    id: 2,
    src: '/WEDI.jpg', 
  ...
  { 
    ...
    src: '/CS.jpg', 
    category: 'Flyers',
    title: 'CS Event Flyer',
    description: 'Corporate event flyer design'
  },
  { 
    id: 5,
    src: '/note.jpg', 
    category: 'Flyers',
    title: 'Note Design',
    description: 'Creative note template'
  },
  { 
    id: 6,
    src: '/errando.png', 
  ...
  { 
    ...
    description: 'Beauty salon branding'
  },
  { 
    id: 18,
    src: '/emmt.png', 
  ...
  { 
    ...
    src: '/aviation.jpg', 
    category: 'Flyers',
    title: 'Aviation Flyer',
    description: 'Aviation industry promotion'
  },
  { 
    id: 20,
    src: '/electronic.jpg', 
  ...
  { 
    ...
    category: 'Flyers',
    title: 'GenLit Event',
    description: 'Literary event promotion'
  },
  { 
    id: 23,
...
export const PERSONAL_INFO = {
  ...
  instagramHandle: 'Betty-Empire',
  description: "I'm a Creative Graphic Designer specializing in logos, flyers, and social media designs, offering services like brand identity development, print materials, digital graphics, infographics, and presentation design to help businesses and individuals create unique and effective visual content that increases brand visibility and online presence."
};
